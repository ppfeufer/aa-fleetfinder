...
# AA Fleet Finder
from fleetfinder.app_settings import allianceauth_major_version, template_path
...
class TestBulletinUI(WebTest):
    ...
    def test_should_return_aa_major_version(self):
        ...
        with patch(
            target="fleetfinder.app_settings.allianceauth__version", new="4.0.0"
        ):
    ...
    def test_should_return_template_path(self):
        ...
        with patch(
            ...
            expected_template_path = "fleetfinder"
    ...
    def test_should_return_legacy_template_path(self):
        ...
        with patch(
            target="fleetfinder.app_settings.allianceauth__version", new="3.7.1"
        ):
            current_template_path = template_path()
            expected_template_path = "fleetfinder/legacy_templates"
